...
<div class="${properties.kcLogin!} medidex-login">
  <div class="${properties.kcLoginContainer!} medidex-card">
    ...
    <main class="${properties.kcLoginMain!}">
      <div class="${properties.kcLoginMainHeader!}">
        <div class="medidex-logo" role="img" aria-label="${realm.displayName!'Medidex'}"></div>
        <h1 class="${properties.kcLoginMainTitle!}" id="kc-page-title"><#nested "header"></h1>
        <#if medidexSubtitleKey??>
          <p class="medidex-subtitle">${msg(medidexSubtitleKey)}</p>
        </#if>
